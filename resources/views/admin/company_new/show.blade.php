                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-2 text-center">
                                @if($company->logo)
                                    <img src="{{ asset('company_logos/'.$company->logo) }}" alt="{{ $company->name }}" class="img-responsive" style="max-width: 150px;">
                                @else
                            ...
                            <div class="col-md-5">
                                ...
                                <p><i class="fa fa-globe"></i> {{ $company->website ?? 'N/A' }}</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat purple">
                    ...
                    <div class="details">
                        ...
                        <div class="desc">Total View PostsFollowers</div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#jobs" aria-controls="jobs" role="tab" data-toggle="tab">
                                    <i class="fa fa-briefcase"></i> Jobs ({{ $company->jobs()->count() }})
                                </a>
                            </li>
                            <li role="presentation">
        ...
        <div class="modal-content">
            <form action="{{ route('companies.send-notification', $company->id) }}" method="POST">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Send Notification to {{ $company->name }}</h4>
                </div>
...
$(document).ready(function() {
    ...
    // FIXED: Initialize DataTables properly
    setTimeout(function() {
        // Destroy existing DataTables instances first
        if ($.fn.DataTable.isDataTable('#allPostsTable')) {
            $('#allPostsTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#jobPostsTable')) {
            $('#jobPostsTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#regularPostsTable')) {
            $('#regularPostsTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#likesTable')) {
            $('#likesTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#commentsTable')) {
            $('#commentsTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#sharesTable')) {
            $('#sharesTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#viewsTable')) {
            $('#viewsTable').DataTable().destroy();
        }
        if ($.fn.DataTable.isDataTable('#followersTable')) {
            $('#followersTable').DataTable().destroy();
        }
    ...
    // // FIXED: View post details - Use event delegation
    ...
    // FIXED: Delete post with event delegation
    ...
    // FIXED: Toggle post status with event delegation
    ...
    // FIXED: Delete comment with event delegation
    ...
    // FIXED: Toggle comment status with event delegation

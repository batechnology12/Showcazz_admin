                                ...
                                <tbody>
                                    ...
                                    <tr id="companyRow{{ $company->id }}">
                                        ...
                                        <td>
                                            ...
                                            @if($company->verified)
                                                <span class="label label-success" title="Verified Company">
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $company->job_posts_count ?? 0 }}</span>
                                        </td>
                                        <td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="13" class="text-center">No companies found</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
...
$(document).ready(function() {
    ...
    $('.toggle-status').click(function() {
        ...
        Swal.fire({
            title: statusText + ' Company?',
            text: "Are you sure you want to " + statusText.toLowerCase() + " this company account?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: newStatus == 1 ? '#26C281' : '#d33',
            confirmButtonText: 'Yes, ' + statusText.toLowerCase() + ' it!'
        }).then((result) => {
    ...
    // Toggle featured (commented out as per your blade)

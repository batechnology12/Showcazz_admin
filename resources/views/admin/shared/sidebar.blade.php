...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('users.index', ['usertype' => 'professional']) }}" class="nav-link">
                            ...
                            @php
                                $professionalCount = \App\User::where('usertype', 'professional')
                                    ->where('is_active', 1)
                                    ->count();
                            @endphp
        ...
        @if (APAuthHelp::checkPermission('manage_reports') || APAuthHelp::checkPermission('manage_firebase_analytics'))
            <li
                class="nav-item {{ request()->routeIs('admin.reports.*') || request()->routeIs('admin.analytics.*') ? 'active' : '' }}">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    @if (APAuthHelp::checkPermission('manage_reports'))
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.reports.posts*') ? 'active' : '' }}">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.posts.popular') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.posts.engagement') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.posts.categories') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.reports.jobs*') ? 'active' : '' }}">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.jobs.posted') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.jobs.applied') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.jobs.by-type') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.jobs.by-company') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.reports.engagement*') ? 'active' : '' }}">
                            ...
                            <ul class="sub-menu">
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.engagement') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.engagement.time-spent') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.engagement.page-views') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.reports.engagement.interactions') ? 'active' : '' }}">
                    ...
                    @if (APAuthHelp::checkPermission('manage_firebase_analytics'))
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.analytics.*') ? 'active open' : '' }}">
                            ...
                            <ul class="sub-menu">
                                <li
                                    class="nav-item {{ request()->routeIs('admin.analytics.dashboard') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.analytics.retention') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.analytics.realtime') ? 'active' : '' }}">
        ...
        @if (APAuthHelp::checkPermission('manage_notifications'))
            <li class="nav-item {{ request()->routeIs('admin.notifications.*') ? 'active' : '' }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li
                        class="nav-item {{ request()->routeIs('admin.notifications.advanced.form') ? 'active' : '' }}">

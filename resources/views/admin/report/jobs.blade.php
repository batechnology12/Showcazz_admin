    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <a href="{{ route('admin.reports.jobs.export', ['period' => $period, 'start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" class="btn btn-sm btn-success">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <div id="customDateSection" class="collapse {{ $period == 'custom' ? 'in' : '' }} margin-top-20">
                            <div class="well">
                                <form action="{{ route('admin.reports.jobs') }}" method="GET" class="form-inline">

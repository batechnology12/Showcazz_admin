    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <a href="{{ route('admin.reports.users.export', request()->query()) }}" class="btn btn-sm btn-success">
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div id="customDateSection" class="collapse {{ $period == 'custom' ? 'in' : '' }}">
                        <div class="portlet-body" style="background: #f9f9f9; border-bottom: 1px solid #eef1f5;">
                            <form method="GET" action="{{ route('admin.reports.users') }}" class="form-inline">
                                <input type="hidden" name="period" value="custom">
                                <div class="form-group" style="margin-right: 10px;">
                                    <label>From:</label>
                                    <input type="date" name="start_date" class="form-control input-sm" value="{{ request('start_date', $date_range['start']->format('Y-m-d')) }}" required>
                                </div>
                                <div class="form-group" style="margin-right: 10px;">
                                    <label>To:</label>
                                    <input type="date" name="end_date" class="form-control input-sm" value="{{ request('end_date', $date_range['end']->format('Y-m-d')) }}" required>
                                </div>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Dormant Users</span>
                        </div>
                        <div class="actions">

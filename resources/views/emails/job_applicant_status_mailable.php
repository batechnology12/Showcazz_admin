                    ...
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    @if($status == 'Declined')
                                     <p>Thank you for applying for the {{$job_title}} position at {{ $company_name }}. After reviewing
your resume/CV, we regret to inform you that we will not be moving forward with your
application.
You can view the job details here and visit the employer’s profile here.
We appreciate your interest and encourage you to apply for future opportunities.</p>    
                                    
                                    @else
                                    <p>We are excited to inform you that {{ $company_name }} has accepted your application for the
{{$job_title}} position. You can view the job details here and visit the employer’s public profile
here.

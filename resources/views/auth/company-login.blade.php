                    ...
                    <div class="userccount whitebg mb-0">
                        ...
                        <div class="tab-content">
                            <div id="employer" class="formpanel mt-0 tab-pane fade active">
                                <h5 class="text-center">{{__('Employer Login')}}</h5>
                                <div class="socialLogin">

                                            <a href="{{ url('login/employer/google')}}" class="gp"><i class="fa-brands fa-google"></i></a>
                                            <a href="{{ url('login/employer/facebook')}}" class="fb"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                                            <a href="{{ url('login/employer/twitter')}}" class="tw"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path></svg></a>
                                ...
                                <!-- sign up form -->
                        <div class="newuser"><i class="fas fa-user" aria-hidden="true"></i> {{__('New User')}}? <a href="{{url('company-register')}}">{{__('Register Here')}}</a></div>

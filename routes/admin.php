...
Route::group(['prefix' => 'admin_roles', 'middleware' => ['auth:admin']], function() {
    ...
    Route::post('/', 'Admin\RoleController@store')->name('admin.roles.store');
    Route::get('/{id}/edit', 'Admin\RoleController@edit')->name('admin.roles.edit');
    Route::put('/{id}', 'Admin\RoleController@update')->name('admin.roles.update');
    Route::delete('/{id}', 'Admin\RoleController@destroy')->name('admin.roles.destroy');
});



Route::group(['prefix' => 'admin_notification', 'middleware' => ['auth:admin']], function() {
    
    // Notification Dashboard
    Route::get('dashboard', 'Admin\AdminNotificationController@dashboard')->name('admin.notifications.dashboard');
    
    // Send Notifications
    Route::get('send', 'Admin\AdminNotificationController@showSendForm')->name('admin.notifications.send.form');
    Route::post('send', 'Admin\AdminNotificationController@sendNotification')->name('admin.notifications.send');
    
    // Advanced Send Notifications
    Route::get('advanced-send', 'Admin\AdminNotificationController@showAdvancedSendForm')->name('admin.notifications.advanced.form');
    Route::post('advanced-send', 'Admin\AdminNotificationController@sendAdvancedNotification')->name('admin.notifications.advanced.send');
    
    // Send to Specific Groups
    Route::post('send/all', 'Admin\AdminNotificationController@sendToAllUsers')->name('admin.notifications.send.all');
    Route::post('send/companies', 'Admin\AdminNotificationController@sendToCompanies')->name('admin.notifications.send.companies');
    Route::post('send/students', 'Admin\AdminNotificationController@sendToStudents')->name('admin.notifications.send.students');
    Route::post('send/professionals', 'Admin\AdminNotificationController@sendToProfessionals')->name('admin.notifications.send.professionals');
    Route::post('send/subscribed', 'Admin\AdminNotificationController@sendToSubscribedUsers')->name('admin.notifications.send.subscribed');
    
    // Send to Custom Selected Users
    Route::post('send/custom', 'Admin\AdminNotificationController@sendToCustomUsers')->name('admin.notifications.send.custom');
    
    // Notification History
    Route::get('history', 'Admin\AdminNotificationController@history')->name('admin.notifications.history');
    Route::get('history/{id}', 'Admin\AdminNotificationController@viewNotification')->name('admin.notifications.view');
    Route::delete('history/{id}', 'Admin\AdminNotificationController@deleteNotification')->name('admin.notifications.delete');
    
    // User & Post Selection for Advanced Notifications
    Route::get('users/search', 'Admin\AdminNotificationController@searchUsers')->name('admin.notifications.users.search');
    Route::get('posts/search', 'Admin\AdminNotificationController@searchPosts')->name('admin.notifications.posts.search');
    
    // Notification success page
    Route::get('success/{id}', 'Admin\AdminNotificationController@success')->name('admin.notifications.success');
    
    // Notification Statistics
    Route::get('stats', 'Admin\AdminNotificationController@statistics')->name('admin.notifications.stats');
});




Route::group(['prefix' => 'admin_analytics', 'middleware' => ['auth:admin']], function() {
    // View Pages
    Route::get('dashboard', [App\Http\Controllers\Admin\AnalyticsController::class, 'dashboard'])->name('admin.analytics.dashboard');
    Route::get('retention', [App\Http\Controllers\Admin\AnalyticsController::class, 'retention'])->name('admin.analytics.retention');
    Route::get('realtime', [App\Http\Controllers\Admin\AnalyticsController::class, 'realtime'])->name('admin.analytics.realtime');
    
    // API endpoints for AJAX
    Route::get('api/dashboard-data', [App\Http\Controllers\Admin\AnalyticsController::class, 'getDashboardData'])->name('admin.analytics.api.dashboard');
    Route::get('api/retention-data', [App\Http\Controllers\Admin\AnalyticsController::class, 'getRetentionData'])->name('admin.analytics.api.retention');
    Route::get('api/realtime-data', [App\Http\Controllers\Admin\AnalyticsController::class, 'getRealtimeData'])->name('admin.analytics.api.realtime');
});
...
// ============================================
Route::group(['prefix' => 'admin_subscription', 'middleware' => ['auth:admin']], function() {
    
    // Dashboard
    Route::get('dashboard', 'Admin\AdminSubscriptionController@dashboard')->name('admin.subscriptions.dashboard');
    
    // Package Management
    Route::get('packages', 'Admin\AdminSubscriptionController@packages')->name('admin.subscriptions.packages');
    Route::get('packages/create', 'Admin\AdminSubscriptionController@createPackage')->name('admin.subscriptions.packages.create');
    Route::post('packages', 'Admin\AdminSubscriptionController@storePackage')->name('admin.subscriptions.packages.store');
    Route::get('packages/{id}/edit', 'Admin\AdminSubscriptionController@editPackage')->name('admin.subscriptions.packages.edit');
    Route::put('packages/{id}', 'Admin\AdminSubscriptionController@updatePackage')->name('admin.subscriptions.packages.update');
    Route::delete('packages/{id}', 'Admin\AdminSubscriptionController@deletePackage')->name('admin.subscriptions.packages.delete');
    Route::post('packages/{id}/toggle-status', 'Admin\AdminSubscriptionController@togglePackageStatus')->name('admin.subscriptions.packages.toggle');
    
    // Payment Requests
    Route::get('requests', 'Admin\AdminSubscriptionController@paymentRequests')->name('admin.subscriptions.requests');
    Route::get('requests/{id}', 'Admin\AdminSubscriptionController@viewPaymentRequest')->name('admin.subscriptions.requests.view');
    Route::post('requests/{id}/update-status', 'Admin\AdminSubscriptionController@updatePaymentRequestStatus')->name('admin.subscriptions.requests.update-status');
    
    // Transactions
    Route::get('transactions', 'Admin\AdminSubscriptionController@transactions')->name('admin.subscriptions.transactions');
    Route::get('transactions/export', 'Admin\AdminSubscriptionController@exportTransactions')->name('admin.subscriptions.transactions.export');
    Route::get('transactions/{id}', 'Admin\AdminSubscriptionController@viewTransaction')->name('admin.subscriptions.transactions.view');
    
    // Company Subscriptions
    Route::get('companies', 'Admin\AdminSubscriptionController@companySubscriptions')->name('admin.subscriptions.companies');
    Route::get('companies/{id}', 'Admin\AdminSubscriptionController@viewCompanySubscription')->name('admin.subscriptions.companies.view');
    Route::post('companies/{id}/update-package', 'Admin\AdminSubscriptionController@updateCompanyPackage')->name('admin.subscriptions.companies.update-package');
    
    // Reports
    Route::get('reports', 'Admin\AdminSubscriptionController@reports')->name('admin.subscriptions.reports');
    Route::get('reports/export', 'Admin\AdminSubscriptionController@exportReports')->name('admin.subscriptions.reports.export');
});
...
Route::group(['prefix' => 'admin_post', 'middleware' => ['auth:admin']], function() {
    ...
    Route::post('posts/{id}/toggle-status', 'Admin\AdminPostController@toggleStatus')->name('admin.posts.toggle-status');

...
class JobSeekerController extends Controller
{
    ...
    public function jobSeekersBySearch(Request $request)
    {
        ...
        $limit = 10;
        $jobSeekers = User::where('is_active', 1) // Fetch all active users
        ->orderByDesc('is_featured') // Show featured users first
        ->paginate(10);
        // $jobSeekers = $this->fetchJobSeekers($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, $order_by);
